...
class Thantyou extends React.Component {
  ...
  render() {
    ...
    let product = orderData.lineItems && orderData.lineItems.nodes ? orderData.lineItems.nodes[0] : ''
    return (
      <div className='settle_accounts'>
        {
          product ? <div className='product_box thank_product_box' >
        ...
        {
          orderData.id ? <div className='order_box' >
